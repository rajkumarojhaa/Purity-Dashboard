...
const Navbar = () => {
  ...
  return (
    <div className="w-full  max-w-full absolute h-16 md:h-20 lg:h-24 bg-zinc-100 shadow-md flex items-center px-4 md:px-6 lg:px-8 justify-between">
      ...
      <div className="flex items-center gap-2 md:gap-3 lg:gap-4">
        ...
        {/* Navigation Links - Now only visible on large devices */}
      ...
      <div className="flex justify-start items-center gap-1 md:gap-2">
        ...
        {/* Burger Menu Button - Now hidden only on large screens */}
