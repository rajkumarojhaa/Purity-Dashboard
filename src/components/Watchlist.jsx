...
const Watchlist = () => {
  ...
  return (
    <main className="p-15 w-[1920px]  overflow-hidden bg-zinc-100 ">
      <div className="flex justify-between items-center mb-4 mt-30">
        <div>
          <div className="w-32 h-6 justify-start text-gray-700 text-lg font-bold font-['Helvetica'] leading-relaxed">
            Watchlist
          </div>
          <div className="w-[515px] justify-start text-gray-700 text-opacity-50 text-sm font-medium font-['Poppins'] capitalize leading-tight">
        ...
        <div className="flex space-x-2">
          ...
          <div className="px-4 py-2 bg-zinc-300 inline-flex justify-center items-center gap-2.5 overflow-hidden">
            ...
            <div className="text-right justify-start text-stone-900 text-base font-medium font-['Poppins'] leading-snug">
              Read all
            </div>
          </div>
        </div>
      ...
      <div className="flex space-x-2">
        ...
        <div className="w-44 h-12 bg-zinc-300 rounded-3xl flex items-center px-4">
          ...
          <div className="w-6 h-6 relative ">
            <img
              className="w-6 h-6 left-15  absolute "
